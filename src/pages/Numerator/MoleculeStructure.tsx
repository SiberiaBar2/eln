...
// import "@rdkit/rdkit/dist/RDKit_minimal.wasm";
...
class MoleculeStructure extends Component<PropsType, StateType> {
  static propTypes = {
    /**
     * Generic properties
     */
  ...
  drawSVGorCanvas() {
    const mol = (window as any).RDKit.get_mol(
      this.props.structure || "invalid",
    );
    const qmol = (window as any).RDKit.get_qmol(
      this.props.subStructure || "invalid",
    );
  ...
  getMolDetails(mol: any, qmol: any) {
